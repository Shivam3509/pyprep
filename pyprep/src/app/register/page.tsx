        ...
        <div className="bg-white py-8 px-4 border border-slate-200 sm:rounded-lg sm:px-10 shadow-xs space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-2 rounded font-bold text-xs bg-brand-600 hover:bg-brand-700 text-white transition-all shadow-sm flex items-center justify-center gap-1.5 disabled:opacity-55"
            >
              {isSubmitting ? (
                <>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-white text-slate-400 font-semibold">Or register with</span>
            </div>
          </div>
